        ...
        return new Promise(function (resolve, reject) {
            ...
            ffmpegCmd
                ...
                .outputOptions([
                    '-hls_time 10',
                    '-start_number 1',
                    `-hls_segment_filename ${process.env.TEMP_FILES_PATH}/brhythm_${fileIdentifier}_adts_stream.mp4`,
                    '-hls_segment_type fmp4',
                    '-hls_flags single_file+independent_segments',
                    '-hls_playlist_type vod'
                ])
                .output(`${process.env.TEMP_FILES_PATH}/brhythm_${fileIdentifier}_index.m3u8`)
